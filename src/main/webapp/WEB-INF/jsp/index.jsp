	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="hidden-xs hidden-sm col-lg-2 col-md-2 col-sm-6" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
				...
				<div class="col-md-10 col-xs-12 col-lg-10">
					<div class="col-md-6 hidden-xs hidden-sm" style="text-align:center;height:200px;padding:0px;">
				...
				<c:forEach items="${nList}" var="p">
					<div class="col-md-2 col-xs-6 col-sm-4" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath }/product/getProductById?pid=${p.pid}">
							<img src="${pageContext.request.contextPath}/${p.image}" width="130" height="130" style="display: inline-block;">
						</a>
			...
			<div class="container-fluid">
				...
				<div class="hidden-xs hidden-sm col-lg-2 col-md-2 " style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="${pageContext.request.contextPath}/products/hao/big01.jpg" width="205" height="404" style="display: inline-block;"/>
				</div>
				<div class="col-md-10 col-xs-12 col-lg-10">
					<div class="col-md-6 hidden-xs hidden-sm" style="text-align:center;height:200px;padding:0px;">
